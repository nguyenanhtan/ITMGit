...
public class AjaxController {
    ...
    public @ResponseBody
    String addDefenseSession(@RequestParam(value = "dateDefense") String dateDefense, @RequestParam(value = "desDefense") String desDefense, @RequestParam(value = "actDefense") String actDefense) {
    ...
    public @ResponseBody
    boolean delDefenseSession(@RequestParam(value = "id") String id) {
    ...
    public @ResponseBody
    boolean updateDefenseSession(@RequestParam(value = "id") String id,@RequestParam(value = "date") String date,@RequestParam(value = "des") String des,@RequestParam(value = "act") String act) {
		Defensesession dels = new Defensesession();
		dels.setId(id);
		dels.setDate(date);
    ...
    public @ResponseBody
    boolean addInstitute(@RequestParam(value = "name") String name,@RequestParam(value = "des") String des) {
    ...
    public @ResponseBody
    boolean addDepartment(@RequestParam(value = "name") String name,@RequestParam(value = "des") String des, @RequestParam(value = "idIns") String idIns) {
    ...
    public @ResponseBody
    boolean removeInstitute(@RequestParam(value = "id") String id) {
		Institutes ins = new Institutes();
		ins.setId(id);
    ...
    public @ResponseBody
    boolean addClass(@RequestParam(value = "idDpm") String idDpm, @RequestParam(value = "name") String name, @RequestParam(value = "des") String des) {
    ...
    public @ResponseBody
    List<Classes> getClassByDepartment(@RequestParam(value = "idDpm") String idDpm) {		
		
		return clssvc.listClasses(idDpm);
	}
	@RequestMapping(value = "/removeDepartment", method = RequestMethod.GET)
    public @ResponseBody
    boolean removeDepartment(@RequestParam(value = "idDpm") String idDpm) {
    ...
    public @ResponseBody
    boolean removeClass(@RequestParam(value = "idCls") String idCls) {
		Classes cls = new Classes();
		cls.setId(idCls);
    ...
    public @ResponseBody
    boolean addStudent(@RequestParam(value = "name") String name, @RequestParam(value = "id") String id, @RequestParam(value = "mail") String mail ,@RequestParam(value = "tel") String tel ,@RequestParam(value = "type") String type ,@RequestParam(value = "class") String cls ,@RequestParam(value = "promotion") String prm ,@RequestParam(value = "status") String status ) {
    ...
    public @ResponseBody
    boolean removeStudent(@RequestParam(value = "id") String id) {
		SuperviseStudent spv = new SuperviseStudent();
		spv.setId(id);
    ...
    public @ResponseBody
    List<Department> listDepartmentInstitute(@RequestParam(value = "id") String id) {
		List<Department> ldp = dpmsvc.listDepartmentsInInstitute(id);
		return ldp;
	}
	@RequestMapping(value = "/addSubjectCategory", method = RequestMethod.GET)
    public @ResponseBody
    SubjectCategory addSubjectCategory(@RequestParam(value = "name") String name, @RequestParam(value = "des") String des) {
    ...
    public @ResponseBody
    SubjectCategory removeSubjectCategory(@RequestParam(value = "id") String id) {
		SubjectCategory sc = new SubjectCategory();
		sc.setId(id);
    ...
    Professor addProfessor(
		...
		for(Object y:x){
			HashMap<String, Double> r = gs.fromJson(y.toString(), HashMap.class);
    ...
    public @ResponseBody
    Slot addSlot(@RequestParam(value = "name") String name, @RequestParam(value = "start") String start, @RequestParam(value = "end") String end) {
		Slot sl = new Slot();
		sl.setName(name);
		sl.setEnd(end);
		sl.setStart(start);
    ...
    public @ResponseBody
    Room addRoom(@RequestParam(value = "name") String name,@RequestParam(value = "capacity") String cap) {
		Room sl = new Room();
		sl.setName(name);
		sl.setCapacity(cap);
		srms.persistRoom(sl);
    ...
    public @ResponseBody
    Room rmRoom(@RequestParam(value = "id") String id) {
		Room sl = new Room();
		sl.setId(id);
		srms.deleteRoom(sl);
		return sl;
    ...
    public @ResponseBody
    Slot rmSlot(@RequestParam(value = "id") String id) {
		Slot sl = new Slot();
		sl.setId(id);
		srms.deleteSlot(sl);
		return sl;
    ...
    public @ResponseBody
    List<SuperviseStudent> searchStudentByName(@RequestParam(value = "name") String name) {
		List<SuperviseStudent> lStudent = supStudentSvc.listSuperviseStudent(name);
		return lStudent;
